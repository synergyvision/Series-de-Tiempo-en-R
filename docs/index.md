...
\BeginKnitrBlock{definition}<div class="definition"><span class="definition" id="def:defi-modelo-log-lineal_1"><strong>(\#def:defi-modelo-log-lineal_1) </strong></span>El modelo **Logarítmico Lineal** o **Log-Lineal** se define como
\begin{equation}
...
![](Serie-de-Tiempo-en-R_files/figure-html/unnamed-chunk-26-2.svg)<!-- -->
...
![](Serie-de-Tiempo-en-R_files/figure-html/unnamed-chunk-26-3.svg)<!-- -->
